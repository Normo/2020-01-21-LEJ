...
venue: "UFZ"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Leipzig"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latitude: "51.343479"     # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: 12.3877721"    # decimal longitude of the workshop venue (use https://www.latlong.net)
